...
Open the wallets with cuddle-service like so:

./cuddle-service -w walletA.wallet -p yourpass --rpc-password test --daemon-port 12897 --bind-port 8070
./cuddle-service -w walletB.wallet -p yourpass --rpc-password test --daemon-port 12897 --bind-port 8071
