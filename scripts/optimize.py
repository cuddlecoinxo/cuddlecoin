# USAGE: Start cuddle-service as you usually would
...
from cuddlecoincoin import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="CuddleCoin address to optimize", required=True)
