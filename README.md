...
We offer binary images of the latest releases here: [https://github.com/cuddlecoinxo/cuddlecoin/releases/latest](https://github.com/cuddlecoinxo/cuddlecoin/releases/latest)
...
From the start menu, open 'x64 Native Tools Command Prompt for VS 2019'.
    ...
    MSBuild CuddleCoin.sln /p:Configuration=Release /m or MSBuild src\cli.vcxproj /p:Configuration=Release /m

**For 32-bit:**

From the start menu, open 'x86 Native Tools Command Prompt for VS 2019'.

    cd <your_cuddlecoin_directory>
    mkdir build
    cd build
    cmake -G "Visual Studio 16 2019" -A Win32 .. -DBOOST_ROOT=C:/local/boost_1_69_0
    MSBuild CuddleCoin.sln /p:Configuration=Release /p:Platform=Win32 /m

The binaries will be in the src/Release folder when you are complete.

    cd src
    cd Release
    CuddleCoind.exe --version
...
#### Thanks
Cryptonote Developers, Bytecoin Developers, Monero Developers, Forknote Project, 2ACoin Community, CuddleCoin Community

### Copypasta for license when editing files

Hi CuddleCoin contributor, thanks for forking and sending back Pull Requests. Extensive docs about contributing are in the works or elsewhere. For now this is the bit we need to get into all the files we touch. Please add it to the top of the files, see [src/CryptoNoteConfig.h](https://github.com/cuddlecoinxo/cuddlecoin/blob/development/src/CryptoNoteConfig.h) for an example.
